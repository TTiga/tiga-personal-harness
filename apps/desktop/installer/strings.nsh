...
LangString INSTALLER_CHOOSE_DATA ${LANG_ENGLISH} "Choose data location"
LangString INSTALLER_CHOOSE_DATA ${LANG_SIMPCHINESE} "选择数据目录"
LangString INSTALLER_DATA_LABEL ${LANG_ENGLISH} "Sessions, credentials and plugins will be stored in this folder."
LangString INSTALLER_DATA_LABEL ${LANG_SIMPCHINESE} "会话、凭据与插件将保存在此目录。"
LangString INSTALLER_DATA_WRITABLE ${LANG_ENGLISH} "This data folder is not writable. Choose a folder available to the current user."
LangString INSTALLER_DATA_WRITABLE ${LANG_SIMPCHINESE} "无法写入此数据目录。请选择当前用户可写入的文件夹。"
